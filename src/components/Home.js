...
const Home = () => {
    return (
        <div>
            ...
            <div className="refer">
                <span>UI/UX <i className='bx bx-chevron-right'></i> Refer & Earn</span>
            </div>

            <div className="referlas-container">
                <div className="referlas">
                    <div className="referlas-block">
                        <span>Referral Earning</span>
                        <span className="referlas-num">$ 2,500</span>
                    </div>
                    <div className="referlas-block">
                        <span>Total Referrals</span>
                        <span className="referlas-num">7</span>
                    </div>
                    <div className="referlas-block">
                        <span>Wallet Balance</span>
                        <span className="referlas-num">$ 500</span>
                    </div>
                    <div className="withdrow">
                        <span>Withdraw Balance</span>
                    </div>
                </div>
                <div className="refral-code-container">
                    <span className="refral-code">Your Referral Code</span>
                    ...
                    <div className="">
                        <div className="ques-flex">
                            ...
                            <div className="flex-c">
                                <span className="ques-name">invite your friends</span>
                                <span className="ques-msg">Share the link tutedude.com with your friends</span>
                            </div>
                        </div>
                        <div className="ques-flex">
                            <div>
                            ...
                            <div className="flex-c">
                                <span className="ques-name">You get $ 200 as referral money</span>
                                <span className="ques-msg">On total purchase the friend makes, into your wallet</span>
                            </div>
                        </div>
                        <div className="ques-flex">
                            <div>
                            ...
                            <div className="flex-c">
                                <span className="ques-name">Transfer money from wallet</span>
                                <span className="ques-msg">When the wallet balance reaches $ 200 or more, you can withdrow it.</span>
                            </div>
                        </div>
                    </div>
                    <div className="container-right">
                        <div className="">
                            <div className="ques-flex">
                                ...
                                <div className="flex-c">
                                    <span className="ques-name">Friend purchase any course</span>
                                    <span className="ques-msg">Using your REFERRAL CODE int the payments page</span>
                                </div>
                            </div>
                            <div className="ques-flex">
                                <div>
                                ...
                                <div className="flex-c">
                                    <span className="ques-name">Your Friend gets $ 200 Off</span>
                                    <span className="ques-msg">On his overall fee on succssful purchase using your referral code</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="footer">
                <NavLink to="/enrolled" className="a">Friends who Enrolled</NavLink>
